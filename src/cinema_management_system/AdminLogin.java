...
public class AdminLogin extends CenteredFrame {
    public AdminLogin() {
        initComponents();
    }
    ...
    char[] passwordChars = jPasswordField1.getPassword();  // Retrieve the password as a character array
    ...
    if (password.equals("123")) {
        ...
        dispose();  // Dispose the resources of the first GUI
    } else {
