...
public class RemoveMovie extends CenteredFrame {
    private List<AddMovie> movies;

    public RemoveMovie(List<AddMovie> movies) {
        this.movies = movies;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (removeMovie(input)) {
            JOptionPane.showMessageDialog(this, "Movie Removed", "Success", JOptionPane.INFORMATION_MESSAGE);
        } else {
