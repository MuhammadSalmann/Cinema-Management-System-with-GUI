...
public class EditShowtime extends CenteredFrame {
    private List<AddMovie> movies;

    public EditShowtime(List<AddMovie> movies) {
        this.movies = movies;
        initComponents();
    }
    
    public boolean updateShowtime(String title, String showtime) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         String showtime = jTextField2.getText();
        if (updateShowtime(title, showtime)) {
            JOptionPane.showMessageDialog(this, "Showtime Updated", "Success", JOptionPane.INFORMATION_MESSAGE);
        } else {
